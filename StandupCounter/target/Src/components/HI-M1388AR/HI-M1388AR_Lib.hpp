...
// Digits
constexpr uint8_t digit_zero[MATRIX_SIZE]  = { 0x7E, 0x18, 0x18, 0x18, 0x1C, 0x18, 0x18, 0x00 };
constexpr uint8_t digit_one[MATRIX_SIZE]   = { 0x7E, 0x06, 0x0C, 0x30, 0x60, 0x66, 0x3C, 0x00 };
constexpr uint8_t digit_two[MATRIX_SIZE]   = { 0x3C, 0x66, 0x60, 0x38, 0x60, 0x66, 0x3C, 0x00 };
constexpr uint8_t digit_three[MATRIX_SIZE] = { 0x30, 0x30, 0x7E, 0x32, 0x34, 0x38, 0x30, 0x00 };
constexpr uint8_t digit_four[MATRIX_SIZE]  = { 0x3C, 0x66, 0x60, 0x60, 0x3E, 0x06, 0x7E, 0x00 };
constexpr uint8_t digit_five[MATRIX_SIZE]  = { 0x3C, 0x66, 0x66, 0x3E, 0x06, 0x66, 0x3C, 0x00 };
constexpr uint8_t digit_six[MATRIX_SIZE]   = { 0x18, 0x18, 0x18, 0x30, 0x30, 0x66, 0x7E, 0x00 };
constexpr uint8_t digit_seven[MATRIX_SIZE] = { 0x3C, 0x66, 0x66, 0x3C, 0x66, 0x66, 0x3C, 0x00 };
constexpr uint8_t digit_eight[MATRIX_SIZE] = { 0x3C, 0x66, 0x60, 0x7C, 0x66, 0x66, 0x3C, 0x00 };
constexpr uint8_t digit_nine [MATRIX_SIZE] = { 0x3C, 0x66, 0x66, 0x6E, 0x76, 0x66, 0x3C, 0x00 };
