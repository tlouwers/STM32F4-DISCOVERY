 ...
 *                                                                Terry Louwers
 *
 * \brief   Fake Assert/Expect surface for native unit tests. Declares the
 *          same extern "C" hooks the production Assert.h provides so code
 *          using ASSERT() / EXPECT() compiles and links without firmware
 *          breakpoints or reset behaviour.
 *
