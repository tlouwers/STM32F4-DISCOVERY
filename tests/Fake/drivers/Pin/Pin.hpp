 ...
 * \class   Pin
 *
 * \brief   Fake Pin driver for native unit tests. Mirrors the real Pin API
 *          (constructors, Configure, Set/Get/Toggle, Interrupt*) as no-ops
 *          so non-injected components compile against it.
 *
 * \note    https://github.com/tlouwers/STM32F4-DISCOVERY/tree/develop/tests/Fake/drivers/Pin
 *
