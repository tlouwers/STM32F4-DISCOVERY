 ...
 * \class   Mock_SPI
 *
 * \brief   GMock implementation of the ISPI interface for TiltExample.
 *
 * \note    https://github.com/tlouwers/STM32F4-DISCOVERY/tree/develop/projects/TiltExample/tests/Mock
 *
