 ...
 * \class   Pin
 *
 * \brief   Fake Pin driver for TiltExample native unit tests. Mirrors the
 *          real Pin API as no-ops so non-injected components compile against it.
 *
 * \note    https://github.com/tlouwers/STM32F4-DISCOVERY/tree/develop/projects/TiltExample/tests/Fake/drivers/Pin
 *
