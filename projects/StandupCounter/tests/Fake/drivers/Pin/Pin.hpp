 ...
 * \class   Pin
 *
 * \brief   Fake Pin driver for StandupCounter native unit tests. Mirrors the
 *          real Pin API as no-ops so non-injected components compile against it.
 *
 * \note    https://github.com/tlouwers/STM32F4-DISCOVERY/tree/develop/projects/StandupCounter/tests/Fake/drivers/Pin
 *
