 ...
 *                                                                Terry Louwers
 *
 * \brief   Fake Assert/Expect surface for StandupCounter native unit tests.
 *          Declares the extern "C" hooks the production header provides.
 *
 * \note    https://github.com/tlouwers/STM32F4-DISCOVERY/tree/develop/projects/StandupCounter/tests/Fake/utility/Assert
 *
