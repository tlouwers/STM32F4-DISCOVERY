...
| Guides | CLI usage, GUI walkthrough, README quick-start, hardware wiring notes | Done — `docs/cli.md`, README quick-start; wiring + GUI walkthrough in `end_to_end_test.md` |
