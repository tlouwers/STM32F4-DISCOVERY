 ...
 *          an external slave and are UNTRUSTED. The caller owns 'dest' and must
 *          size it to at least 'length'; the transfer is bounded by 'length' but
 *          the CONTENT must be validated by the caller before use.
 *
